...
our @TOP_COLOR        = (178/255,204/255,92/255); # TOP Backgroud color
...
our @COLOR_PARTS      = (170/255, 170/255, 255/255, 1);       # Perimeter color
our @COLOR_INFILL     = (1, 0.45, 0.45, 1);
our @COLOR_SUPPORT    = (0.5, 1, 0.5, 1);
our @COLOR_UNKNOWN    = (0.5, 0.5, 1, 1);
our @BED_COLOR        = (255, 255, 255);#2D
our @BED_GRID         = (230, 230, 230);#2D
our @BED_SELECTED     = (255, 152, 101);
our @BED_OBJECTS      = (148, 148, 148);
our @BED_INSTANCE     = (255, 128, 128);
our @BED_DRAGGED      = (128, 128, 255);
our @BED_CENTER       = (200, 200, 200);
our @BED_SKIRT        = (150, 150, 150);
our @BED_CLEARANCE    = (0, 0, 200);#2D
